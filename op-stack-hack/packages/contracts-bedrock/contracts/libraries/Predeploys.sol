...
library Predeploys {
    ...
    address internal constant HYPERLANE_GAS_PAYMASTER = 0x420000000000000000000000000000000000006d;
    address internal constant HYPERLANE_GAS_ORACLE = 0x420000000000000000000000000000000000006f;
    address internal constant HYPERLANE_MULTISIG_ISM = 0x4200000000000000000000000000000000000070;

    // Price Feed
    address internal constant ETH_PRICE_FEED = 0x4200000000000000000000000000000000000071;
}
