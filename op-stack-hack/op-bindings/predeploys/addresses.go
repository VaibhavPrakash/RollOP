...
const (
	...
	HyperlaneGasPaymaster         = "0x420000000000000000000000000000000000006d"
	HyperlaneGasOracle            = "0x420000000000000000000000000000000000006f"
	HyperlaneMultisigIsm          = "0x4200000000000000000000000000000000000070"
	PriceFeedEth                  = "0x4200000000000000000000000000000000000071"
)
...
var (
	...
	HyperlaneGasPaymasterAddr         = common.HexToAddress(HyperlaneGasPaymaster)
	HyperlaneGasOracleAddr            = common.HexToAddress(HyperlaneGasOracle)
	HyperlaneMultisigIsmAddr          = common.HexToAddress(HyperlaneMultisigIsm)
	PriceFeedEthAddr                  = common.HexToAddress(PriceFeedEth)
...
func init() {
	...
	Predeploys["InterchainGasPaymaster"] = &HyperlaneGasPaymasterAddr
	Predeploys["StorageGasOracle"] = &HyperlaneGasOracleAddr
	Predeploys["LegacyMultisigIsm"] = &HyperlaneMultisigIsmAddr
	Predeploys["PriceFeedEth"] = &PriceFeedEthAddr
}
